...
const NavBar = ({ onClick, navLinks }) => {
  ...
  function showSidebar() {
    ...
    if (sidebar.style.left === '0px') {
      ...
      sidebar.style.left = '-100%' // يمكنك تعديل هذا الرقم ليعكس عرض الشريط الجانبي
    } else {
      // فتح الشريط الجانبي
  ...
  return (
    <nav className="w-full h-20 flex justify-between items-center fixed z-50 px-20 py-0 bg-white dark:bg-black max-lg:px-10 max-sm:px-5">
      <div className="logo text-2xl font-bold dark:text-white">
        Portfo<span className="text-blue">lio</span>.
      </div>
      ...
      <div className="flex gap-5 lg:hidden">
        ...
        <button className="dark:text-white" onClick={showSidebar}>
